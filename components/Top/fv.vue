<template>
  <section class="fv" id="fv">
    <div class="fv__text__wrapper">
      <div class="mask">
        <img loading="lazy" src="/img/fv-text1.svg" alt="fv_title" class="fv__text1">
      </div>
      <div class="mask">
        <img loading="lazy" src="/img/fv-text2.svg" alt="fv_title" class="fv__text2">
      </div>
      <div class="mask">
        <img loading="lazy" src="/img/fv-title.svg" alt="fv_title" class="fv__title">
      </div>
    </div>
